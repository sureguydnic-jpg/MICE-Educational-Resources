...
const NavItem: React.FC<NavItemProps> = ({ day, title, subtitle, color, icon, delay, onClick }) => {
  return (
    ...
    >
      ...
      <ChevronRight className="w-6 h-6 text-white/20 group-hover:text-cyan-neon transition-colors" />
...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center p-8 bg-bg-base overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="relative z-10 w-full max-w-5xl">
        ...
        <header className="text-center mb-16">
          <motion.div
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            className="inline-block px-6 py-2 rounded-full border border-cyan-neon/30 bg-cyan-neon/10 mb-6"
          >
            <span className="font-display text-cyan-neon text-sm tracking-[0.2em] font-bold">
          ...
          <motion.h1 
            ...
            className="text-4xl md:text-6xl font-black text-white mb-4 tracking-tight leading-tight"
          >
            AI를 활용한 MICE인재 양성과정<br />
            <span className="neon-text-cyan text-cyan-neon font-display">MICE 현장운영</span>
          </motion.h1>
        ...
        >
          ...
          >
            ...
            <span className="font-bold text-white group-hover:text-yellow-neon transition-colors">
              [별첨] 근로기준법 상식
            </span>
