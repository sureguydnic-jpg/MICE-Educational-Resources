          ...
          >
            ...
            {slide.type === "goal" && (
              <div className="flex flex-col items-center">
                <div className="glass-card p-20 rounded-3xl border-orange-neon/30 max-w-[85vw] w-full flex flex-col items-center">
                  ...
                  <h2 className="text-5xl font-black text-orange-neon mb-16 font-display uppercase tracking-widest">
                    {slide.title}
                  </h2>
                  {slide.content}
                </div>
            ...
            {slide.type === "summary" && (
              <div className="flex flex-col items-center justify-start h-full">
                <div className="glass-card p-12 rounded-4xl border-orange-neon/30 max-w-[85vw] w-full flex flex-col items-center bg-black/80 mt-12">
