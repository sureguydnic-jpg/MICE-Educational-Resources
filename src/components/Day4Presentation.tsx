...
import { day4Slides as slides } from "../data/slides";
  ...
  return (
    <div className="fixed inset-0 z-50 bg-bg-base flex flex-col items-center justify-center p-4 md:p-12 overflow-hidden">
      ...
      <button 
        ...
        className="absolute left-8 top-1/2 -translate-y-1/2 z-[100] p-2 text-orange-neon hover:scale-125 transition-all disabled:opacity-20 disabled:cursor-not-allowed"
      >
        <ChevronLeft size={48} />
      </button>
      <button 
        ...
        className="absolute right-8 top-1/2 -translate-y-1/2 z-[100] p-2 text-orange-neon hover:scale-125 transition-all disabled:opacity-20 disabled:cursor-not-allowed"
      >
            ...
            {slide.type === "goal" && (
              <div className="flex flex-col items-center w-full max-w-[85vw] mx-auto">
                <div className="flex items-center gap-4 mb-12 self-start opacity-60">
                  <div className="text-orange-neon scale-50 origin-left">
                    {slide.icon}
                  </div>
                  <h2 className="text-2xl font-black text-orange-neon font-display uppercase tracking-widest">
                    {slide.title}
                  </h2>
                </div>
                <div className="glass-card px-24 py-20 rounded-4xl border-orange-neon/20 w-full flex flex-col items-center shadow-2xl">
                    ...
                    {slide.items?.map((item, i) => (
                      <div key={i} className="glass-card p-12 rounded-4xl border-white/10 shadow-2xl space-y-6 hover:border-white/30 transition-all">
                        <div className={`flex items-center gap-5 text-4xl font-black pb-6 border-b-2 border-dashed ${
                          ...
                          slide.theme === 'orange' ? 'text-orange-neon border-orange-neon/20' :
